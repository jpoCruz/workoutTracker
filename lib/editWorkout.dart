...
class _EditWorkoutState extends State<EditWorkout> {
                  ...
                  Expanded( //NEW EXERCISE BUTTON
                    child: Align(
                      ...
                      child: MaterialButton(
                        ...
                        child: Text("Update Exercise", style: TextStyle(
  ...
  void getWorkout() async{
    firebase.DataSnapshot snapshot = await _ref.child(widget.exerciseKey).once();

    Map exercise = snapshot.value;

    _exerciseNameController.text = exercise['name'];
    _exerciseSetController.text = exercise['sets'];
    _exerciseRepController.text = exercise['reps'];
    _exerciseSecondsController.text = exercise['seconds'];

    setState(() {
      _typeSelected = exercise['muscleGroup'];
      _weekdaySelected = exercise['day'];
    });
  ...
  void saveWorkout(){
    ...
    _ref.child(widget.exerciseKey).update(workout);
